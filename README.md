...
**The latest release version is tagged `ARSDK3_version_3_12_0`**. This version of the SDK is the one used in the latest versions of FreeFlight Pro and FreeFlight Mini. <br/>
